...
Before I set out to design Giustino, I asked myself, “In which of the many parts
...
for such a project. In addition, I had just bought a K1C and had not yet tested
...
src={diagramma} alt="diagram" height="auto" width="300" /> </div>
...
<div style={{ display: 'flex', gap: '10px', justifyContent: 'center'}}> <Image
src={schema} alt="scheme" height="200" width="300" /> </div>
